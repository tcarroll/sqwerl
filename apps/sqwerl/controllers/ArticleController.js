...
/**
 * Controller that manages read-only views of articles.
 */
Sqwerl.ArticleController = Sqwerl.ViewController.create({

  /**
   * Returns the number of connections (links) that this article has to other things.
   *
   * @return {Number} The number of outgoing links from this thing to other related things.
   */
  connectionCount: Sqwerl.property(function () {
    'use strict';
    return this.sumConnections([
      'authors', 'categories', 'links', 'notes', 'readBy', 'recommendations', 'recommendedBy', 'tags']);
  }),
