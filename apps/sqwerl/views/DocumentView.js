...
Sqwerl.DocumentView = SC.TemplateView.create({
  ...
  createdOnBinding: 'Sqwerl.DocumentController.createdOn',
  creatorBinding: 'Sqwerl.DocumentController.creator',
  ...
  hasMultipleRecommendedByBinding: 'Sqwerl.DocumentController.hasMultipleRecommendedBy',
