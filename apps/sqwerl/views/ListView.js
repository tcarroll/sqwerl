...
Sqwerl.ListView = SC.ListView.extend({
  ...
  focusNextItem: function () {
    ...
    if (index < (size - 1)) {
      ...
      visibleIndex += 1;
      newFocusedIndex =
        this.focusedIndex ? this.focusedIndex.constructor.create() : SC.Object.create({
            index: this.UNFOCUSED_ITEM_INDEX.index,
            isObservable: YES
          });
  ...
  focusPreviousItem: function () {
    ...
    if (index > 0) {
      ...
      index -= 1;
      visibleIndex -= 1;
      newFocusedIndex = this.focusedIndex ? this.focusedIndex.constructor.create() : SC.Object.create({
          index: this.UNFOCUSED_ITEM_INDEX,
          isObservable: YES
        });
      // Scroll this list if the newly focused item isn't visible.
