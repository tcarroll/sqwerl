...
Sqwerl.NavigationItemView = SC.ListItemView.extend(SC.ContentDisplay, {
    ...
    contentDisplayProperties: 'icon isSelected sel node'.w(),

    displayProperties: 'isFocused isHovering isSelected'.w(),
    ...
    render: function (context) {
        ...
        this.renderLabel(working, node ? node.get('pathId') : '', value, isLoading);
     ...
     *
     * @param context                   Required rendering context.
     * @param {String} iconClassName    Required CSS class name of icon.
     * @param {String} [iconTitle]      Optional icon title.
     */
