...
Sqwerl.VideoView = SC.TemplateView.create({
  ...
  createdOnBinding: 'Sqwerl.VideoController.createdOn',
  creatorBinding: 'Sqwerl.VideoController.creator',
  ...
  hasMultipleRecommendedByBinding: 'Sqwerl.VideoController.hasMultipleRecommendedBy',
